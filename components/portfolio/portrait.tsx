...
export function Portrait({scene,step}:{scene:number;step:number}) {
 ...
 return <figure ref={container} className={`portrait-stage portrait-scene-${scene} portrait-step-${step}`} aria-label="Portretten van Dani Roemgens">
  <div className="portrait-wash"/>
  <div className="portrait-composition">
   <div className="portrait-parallax"><div className="portrait-breath"><img width={1366} height={2048} className="portrait-image" src="/dani-studio-v1.png" alt={scene===0||scene===2 ? "Dani Roemgens, zwart-witportret in een donker overhemd" : ""} fetchPriority="high"/></div></div>
  </div>
  <div className="ai-composition"><div className="portrait-parallax"><div className="portrait-breath"><img width={1366} height={2048} className="portrait-image" src="/dani-ai.png" alt={scene===1 ? "Dani Roemgens kijkt naar links" : ""} loading="lazy"/></div></div></div>
  <div className="secondary-composition"><div className="portrait-parallax"><div className="portrait-breath"><img width={1366} height={2048} className="portrait-image" src="/dani-buiten.png" alt={scene===3 ? "Dani Roemgens buiten op een plein" : ""} loading="lazy"/></div></div></div>
