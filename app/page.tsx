...
function Portrait({scene,step}:{scene:number;step:number}) {
 ...
 return <div ref={container} className={`portrait-stage portrait-scene-${scene} portrait-step-${step}`} aria-hidden="true">
  ...
  <div className="portrait-composition">
   <div className="portrait-parallax"><img className="portrait-image" src="/dani-portret.png" alt="" fetchPriority="high"/></div>
  </div>
  <div className="secondary-composition"><div className="portrait-parallax"><img className="portrait-image" src="/dani-buiten.png" alt=""/></div></div>
